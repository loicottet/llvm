...
extern "C" __attribute__((constructor)) void LLVMInitializeAArch64TargetInfo() {
  ...
  RegisterTarget<Triple::UnknownArch, /*HasJIT=*/true> Z(
      getTheAArch64leTarget(), "aarch64", "AArch64 (little endian)", "AArch64");
  RegisterTarget<Triple::UnknownArch, /*HasJIT=*/true> W(
